...
const SEED_USERS: SeedMember[] = [
  ...
  { email: "kai@vectorservicesus.com",     name: "Kai Okafor",      initials: "KO", role: "field",   title: "Lineman II",          hue: 204 },
  { email: "sasha@vectorservicesus.com",   name: "Sasha Petrov",    initials: "SP", role: "field",   title: "Lineman I",           hue: 28  },
  { email: "lena@vectorservicesus.com",    name: "Lena Greer",      initials: "LG", role: "safety",  title: "Safety Officer",      hue: 2   },
  { email: "eli@vectorservicesus.com",     name: "Eli Vance",       initials: "EV", role: "field",   title: "Equipment Operator",  hue: 204 },
  { email: "aubrey@vectorservicesus.com",  name: "Aubrey Nguyen",   initials: "AN", role: "office",  title: "Project Coordinator", hue: 218 },
  { email: "riley@vectorservicesus.com",   name: "Riley Kowalski",  initials: "RK", role: "field",   title: "Apprentice",          hue: 204 },
  { email: "tomas@vectorservicesus.com",   name: "Tomás Delgado",   initials: "TD", role: "foreman", title: "Night Foreman",       hue: 232 },
  { email: "bryn@vectorservicesus.com",    name: "Bryn Mathis",     initials: "BM", role: "office",  title: "AP / Billing",        hue: 28  },
  { email: "casey@vectorservicesus.com",   name: "Casey Whitaker",  initials: "CW", role: "field",   title: "Lineman III",         hue: 207 },
  { email: "hank@vectorservicesus.com",    name: "Hank Pellegrino", initials: "HP", role: "foreman", title: "Foreman C",           hue: 232 },
